          ...
          <nav className="block ml-auto">
            <ul className="z-50 flex flex-col items-start">
              ...
              <li className="z-50 block py-2 mt-6 list-none lg:inline-block">
                <a
                  href={`mailto:deepakjb.2411@gmail.com`}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col-reverse items-start w-full md:flex-row">
              <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                <p className="text-lg">
                  Hello! I&apos;m Deepak and I&apos;m a Full stack developer,
                   from Ghaziabad, India.
                </p>
                <p className="text-lg">
                  After building my first website aged eighteen, I knew I wanted
                  to work with computers and technology, and I&apos;ve never
                  looked back.
                </p>
                <p className="text-lg">
                  After graduating University with a Management degree, I began
                ...
                <p className="text-lg">
                  Alongside my design and development work, I run Media
        ...
        >
          ...
          <div className="flex flex-col-reverse w-full md:flex-row">
            <div className="w-full mb-4 md:pl-0 md:mb-0">
              ...
              <p className="text-lg">
                Email me at{" "}
                <Link href="mailto:deepakjb.2411@gmail.com">
                  <a className="underline-link">deepakjb.2411@gmail.com</a>
                </Link>{" "}
